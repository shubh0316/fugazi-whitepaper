            ...
            {module.lessons.map((lesson) => (
              <li
                ...
                className={clsx(
                  ...
                  "hover:text-[#3CC383] hover:not-has-aria-[current=page]:border-[#3CC383]",
                  "has-aria-[current=page]:border-[#3CC383]",
                )}
              >
                <Link
                  href={`/${lesson.id}`}
                  ...
                  className="aria-[current=page]:font-medium aria-[current=page]:text-[#3CC383]"
                >
                  {lesson.title}
                </Link>
              </li>
