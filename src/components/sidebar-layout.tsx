            ...
            {module.lessons.map((lesson) => (
              <li
                ...
                className={clsx(
                  ...
                  "hover:text-[#C15F3C] hover:not-has-aria-[current=page]:border-[#C15F3C]",
                  "has-aria-[current=page]:border-[#C15F3C]",
                )}
              >
                <Link
                  href={`/${lesson.id}`}
                  ...
                  className="aria-[current=page]:font-medium aria-[current=page]:text-[#C15F3C]"
                >
                  {lesson.title}
                </Link>
              </li>
